...
PLACEMENT_ANALYZING_STATUS = "配置場所を分析中…"
JAPANESE_FOLDER_MULTI_COPYING_STATUS = "Japaneseフォルダを{}箇所にコピー中…"
...
PLACEMENT_LOCATION_NOT_FOUND_ERROR = "適切な配置場所が見つかりません。"
JAPANESE_FOLDER_COPY_FAILED_ERROR = "Japaneseフォルダのコピーに失敗しました。"
...
JAPANESE_FOLDER_PARTIAL_COPY_WARNING = "Japaneseフォルダを{}/{}箇所にコピーしました。\n一部の配置に失敗しました。"
